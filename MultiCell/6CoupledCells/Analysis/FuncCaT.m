...
hold on
plot(ones(size(kmeansdata(1:end-1,4,4)))*2,kmeansdata2(1:end-1,4,4),'o')
plotkmeansdata = [];
...
errorbar(2,mean(plotkmeansdata([1:3,5:end-1])),std(plotkmeansdata([1:3,5:end-1])))
plot(2,mean(plotkmeansdata([1:3,5:end-1])),'x')
anovadata(2,:) = plotkmeansdata(:);
