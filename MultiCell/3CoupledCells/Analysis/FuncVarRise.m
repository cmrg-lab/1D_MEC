...
kmeansdata(:, 1, 1) = std(TimeStartDAD');
...
kmeansdata(:, 2, 1) = std(TimeStartDAD');

filename  = strcat('AnalysisAll2.mat');
load(filename);
    
kmeansdata(:, 2, 4) = std(TimeStartDAD');
...
kmeansdata(:, 3, 1) = std(TimeStartDAD');
...
kmeansdata(:, 4, 1) = std(TimeStartDAD');


filename  = strcat('AnalysisAll2.mat');
load(filename);
    
kmeansdata(:, 4, 4) = std(TimeStartDAD');
...
kmeansdata(:, 1, 2) = std(TimeStartDAD');
...
kmeansdata(:, 2, 2) = std(TimeStartDAD');


filename  = strcat('AnalysisAll2.mat');
load(filename);
    
kmeansdata(:, 2, 5) = std(TimeStartDAD');
...
kmeansdata(:, 3, 2) = std(TimeStartDAD');
...
kmeansdata(:, 4, 2) = std(TimeStartDAD');


filename  = strcat('AnalysisAll2.mat');
load(filename);
    
kmeansdata(:, 4, 5) = std(TimeStartDAD');
...
kmeansdata(:, 1, 3) = std(TimeStartDAD');
...
kmeansdata(:, 2, 3) = std(TimeStartDAD');


filename  = strcat('AnalysisAll2.mat');
load(filename);
    
kmeansdata(:, 2, 6) = std(TimeStartDAD');
...
kmeansdata(:, 3, 3) = std(TimeStartDAD');
...
kmeansdata(:, 4, 3) = std(TimeStartDAD');
...
axis([1 6 0 15e-14]); %set(gca, 'YScale', 'log')
