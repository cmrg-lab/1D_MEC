...
errorbar(3,mean(plotkmeansdata([1:2,4:7,9:end])),std(plotkmeansdata([1:2,4:7,9:end])))
anovadata(3,:) = plotkmeansdata(:);
...
errorbar(5,mean(plotkmeansdata([1:4,6:8,10:end])),std(plotkmeansdata([1:4,6:8,10:end])))
