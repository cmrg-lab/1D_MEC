...
errorbar(5,mean(plotkmeansdata([1:3,5:end])),std(plotkmeansdata([1:3,5:end])))
plot(5,mean(plotkmeansdata([1:3,5:end])),'x')
axis([1 5 10^(-1) 10]); set(gca, 'YScale', 'log')
anovadata(3,:) = [plotkmeansdata(:);NaN];
...
errorbar(1,mean(plotkmeansdata([1:6,8:end])),std(plotkmeansdata([1:6,8:end])))
plot(1,mean(plotkmeansdata([1:6,8:end])),'x')
anovadata(1,:) = plotkmeansdata(:);
...
errorbar(3,mean(plotkmeansdata([1:6,8:end])),std(plotkmeansdata([1:6,8:end])))
plot(3,mean(plotkmeansdata([1:6,8:end])),'x')
...
errorbar(6,mean(plotkmeansdata([1:6,8:end])),std(plotkmeansdata([1:6,8:end])))
plot(6,mean(plotkmeansdata([1:6,8:end])),'x')
axis([1 6 10^(-1) 10]); set(gca, 'YScale', 'log')
anovadata(6,:) = [plotkmeansdata(:);NaN;NaN;NaN];
...
errorbar(2,mean(plotkmeansdata),std(plotkmeansdata))
plot(2,mean(plotkmeansdata),'x')
anovadata(2,1:2) = plotkmeansdata(:);
